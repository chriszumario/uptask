...
export default function DashboardView() {
  ...
  if (data && user) return (
    <>
      ...
      <nav className="my-5 ">
        <Link
          className=" bg-emerald-600 hover:bg-emerald-700 px-10 py-3 text-white font-bold cursor-pointer transition-colors rounded-xl"
          to='/projects/create'
        >Nuevo Proyecto</Link>
      </nav>
      ...
      {data.length ? (
        <ul role="list" className="divide-y divide-gray-100 border border-gray-100 mt-10 bg-white shadow-lg">
          {data.map((project) => (
            <li key={project._id} className="flex justify-between gap-x-6 px-4 py-5">
